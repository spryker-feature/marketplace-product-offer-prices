...
- [PriceProductOfferVolumesRestApi ^1.1.0](https://github.com/spryker/price-product-offer-volumes-rest-api) (Legacy Glue)
- [ProductOfferPricesRestApi ^2.4.0](https://github.com/spryker/product-offer-prices-rest-api) (Legacy Glue)
